...
-   fill argument is used to map the attribute (i.e. DEPENDENCY,ECONOMY ACTIVE)
:::
...
morandi_5 <- c("#D8CFC4", "#C8D4D8", "#B8C2B3", "#D1BEB0", "#9AA7B2")
...
p <- tm_shape(mpsz_pop2020) +
  ...
  tm_title("Distribution of Economically Active Population by Planning Subzone") +
...
#### 2.2.4.2 Plotting choropleth map with custome break
...
#### 2.2.5.1 Using ColourBrewer palette
...
#### 2.2.6.1 Cartographic Furniture
...
#### 2.2.7 Drawing Small Multiple Choropleth Maps
...
#### 2.2.7.1 By assigning multiple values to at least one of the aesthetic arguments
...
#### 2.2.7.2 By defining a group-by variable in tm_facets()
...
#### 2.2.7.3 By creating multiple stand-alone maps with tmap_arrange()
...
#### 2.2.8 Mappping Spatial Object Meeting a Selection Criterion
